...
public class Laboursearchresult extends Activity {
	...
	//String[] ls={"Balan","Rajan","Gopan"};
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.laboursearchresult);
		 s = (TextView) findViewById(R.id.quantity);
	        s.setText(getIntent().getStringExtra
                 ("s"));
	...
	private void get_blog() {
		...
		try {
			...
			httpost = new HttpPost("http://" + General_Data.SERVER_APPLICATION_ADDRESS +
					"/agriappserver/android/getlabourall" +
					".php");
					...
					try {
						...
						list_notifications.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
								...
								Intent i = new Intent(getApplicationContext(), Labourview.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.laboursearchresult, menu);
		return true;
	}
