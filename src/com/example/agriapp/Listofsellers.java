...
public class Listofsellers extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listofsellers);
	...
	private void get_blog() {
		...
		try {
			...
			httpost = new HttpPost("http://" + General_Data.SERVER_APPLICATION_ADDRESS +
					"/agriappserver/android/getsellerall" +
					".php");
					...
					try {
						...
						list_notifications.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
								...
								Intent i = new Intent(getApplicationContext(),Sellerdetails.class);
