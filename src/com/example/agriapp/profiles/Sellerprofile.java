...
import com.example.agriapp.Sellerpofedit;
...
public class Sellerprofile extends Activity {
	...
	String response;
	TextView txt_user, txt_password, txt_nme, txt_con, txt_off, txt_go;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txt_nme = (TextView) findViewById(R.id.txt_nme);
		...
		get_sellerprofile_thread();
	}

	public void get_sellerprofile_thread() {
	...
	private void get_sellerprofile() {
		// TODO Auto-generated method stub
		try {
			httpcnt = new DefaultHttpClient();
			httpost = new HttpPost(
					"http://" + General_Data.SERVER_APPLICATION_ADDRESS + "/agriappserver/android/get_seller.php");
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						txt_nme.setText(json.getJSONObject(0).getString("name"));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sellerprofile, menu);
		return true;
	}
